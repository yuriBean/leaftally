...
<head>
    ...
    @php
        $selectedFont = isset($font) ? $font : (isset($settings_data['retainer_font']) ? $settings_data['retainer_font'] : 'Inter');
        $fontUrl = '';
        switch($selectedFont) {
            case 'Inter':
                            ...
                            <div class="invoice-meta">
                                <table>
                                    <tr>
                                        ...
                                        <td>{{ Utility::dateFormat($settings, $retainer->issue_date) }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>{{ __('Due Date') }}:</strong></td>
                                        <td>{{ Utility::dateFormat($settings, $retainer->due_date) }}</td>
                                    </tr>
                                    @if (!empty($customFields) && count($retainer->customField) > 0)
                                        @foreach ($customFields as $field)
                                            <tr>
                                                <td><strong>{{ $field->name }}:</strong></td>
                                                <td>{{ !empty($retainer->customField) ? $retainer->customField[$field->id] : '-' }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </table>
                        ...
                        <td colspan="6" style="padding: 0; border: none;">
                            <div class="total-section">
                                <table class="total-table">
                                    <tr>
                                        <td>{{ __('Subtotal') }}:</td>
                                        <td class="text-right">{{ Utility::priceFormat($settings, $retainer->getSubTotal()) }}</td>
                                    </tr>
                                    @if ($retainer->getTotalDiscount())
                                        <tr>
                                            <td>{{ __('Discount') }}:</td>
                                            <td class="text-right">-{{ Utility::priceFormat($settings, $retainer->getTotalDiscount()) }}</td>
                                        </tr>
                                    @endif
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right amount-highlight">{{ Utility::priceFormat($settings, $retainer->getSubTotal() - $retainer->getTotalDiscount() + $retainer->getTotalTax()) }}</td>
                                    </tr>
                                </table>
                            </div>
                        </td>
