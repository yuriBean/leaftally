                        ...
                        <div class="card-body table-border-style full-card">
                            <div class="project-info d-flex text-sm">
                                ...
                                <div class="project-info-inner mr-3 col-4">
                                    ...
                                    <div class="project-amnt pt-1">@if(!empty($employee->bankAccount)){{ $employee->bankAccount->bank_name }}@else -- @endif</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <td class="">
                                                        @can('edit allowance')
                                                            <div class="action-btn me-2">
                                                                <a href="#" data-url="{{ URL::to('allowance/'.$allowance->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Allowance')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                            </div>
                                                        @endcan
                                        ...
                                        @foreach ($commissions as $commission)
                                            <tr>
                                                ...
                                                @if ($commission->type == 'fixed')
                                                    <td>{{ \Auth::user()->priceFormat( $commission->amount) }}</td>
                                                @else
                                                    <td>{{ ( $commission->amount) }}% ({{ \Auth::user()->priceFormat($commission->tota_allow) }})</td>
                                                @endif
                                                @if(\Auth::user()->type != 'Employee')
                                                ...
                                                <td class="">
                                                    @can('edit commission')
                                                        <div class="action-btn me-2">
                                                            <a href="#" data-url="{{ URL::to('commission/'.$commission->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Commission')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    @can('edit saturation deduction')
                                                        <div class="action-btn me-2">
                                                            <a href="#" data-url="{{ URL::to('saturationdeduction/'.$saturationdeduction->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Saturation Deduction')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    @can('edit other payment')
                                                        <div class="action-btn me-2">
                                                            <a href="#" data-url="{{ URL::to('otherpayment/'.$otherpayment->id.'/edit') }}" data-size="lg" data-ajax-popup="true" title="{{__('Edit')}}" data-title="{{__('Edit Other Payment')}}" class="mx-3 btn btn-sm  align-items-center bg-info" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                                                ...
                                                <td class="">
                                                    @can('edit overtime')
                                                        <div class="action-btn me-2">
                                                            ...
                                                            <a href="#" data-url="{{ URL::to('overtime/'.$overtime->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit OverTime')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                                                    @can('delete overtime')
                                                        <div class="action-btn ">
