    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" multi-collapse mt-2" id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => ['customer.payment'], 'method' => 'GET', 'id' => 'frm_submit']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::text('date', isset($_GET['date']) ? $_GET['date'] : date('Y-m-d'), ['class' => 'form-control month-btn', 'id' => 'pc-daterangepicker-1']) }}
                                        </div>
                                    </div>
                            ...
                            <div class="col-auto mt-3">
                                <div class="row">
                                    <div class="col-auto d-flex">
                                        ...
                                        <a href="{{ route('customer.payment') }}" class="btn btn-sm btn-danger "
