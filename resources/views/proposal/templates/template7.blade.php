                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ App\Models\Utility::proposalNumberFormat($settings, $proposal->proposal_id) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="color: {{ $color }};">{{ __('Issue Date') }}:</td>
                                        <td class="text-right">
                                            {{ App\Models\Utility::dateFormat($settings, $proposal->issue_date) }}</td>
                                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td>{{ __('Discount') }}:</td>
                                    <td>{{ App\Models\Utility::priceFormat($settings, $proposal->getTotalDiscount()) }}</td>
                                </tr>
