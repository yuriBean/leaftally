                            ...
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ \App\Models\Utility::dateFormat($settings, $proposal->issue_date) }}
                                        </td>
                                    </tr>
                    ...
                    <tr style="border-bottom:1px solid {{ $color }};">
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                <tr style="border-bottom:1px solid {{ $color }};">
                                    <td>{{ __('Subtotal') }}:</td>
                                    <td>{{ \App\Models\Utility::priceFormat($settings, $proposal->getSubTotal()) }}
                                    </td>
                                </tr>
                                @if ($proposal->getTotalDiscount())
                                    <tr style="border-bottom:1px solid {{ $color }};">
                                        <td>{{ __('Discount') }}:</td>
                                        <td>{{ \App\Models\Utility::priceFormat($settings, $proposal->getTotalDiscount()) }}
                                        </td>
                                    </tr>
                                @endif
