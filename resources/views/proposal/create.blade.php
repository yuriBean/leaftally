         ...
         <div class="card-body">
            <div class="row">
               <div class="col-md-6">
                  ...
                  <div class=" text-sm mx-4 text-end">
                    <a href="javascript:void(0)" id="add_customer"><b>{{ __('Add Customer') }}</b></a>
                    </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <x-required></x-required>
                           {{ Form::select('category_id', $category,date('Y-m-d'), array('class' => 'form-control select','required'=>'required')) }}
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                  ...
                  <div class="col-md-12">
                     <div class="border-bottom d-flex align-items-center justify-content-between pb-3 mb-4">
                        ...
                        <div class="all-button-box">
                           ...
                           <a href="javascript:void(0)" data-repeater-create="" class="btn btn-primary" data-toggle="modal" data-target="#add-bank">
                     ...
                     <thead>
                        <tr>
                           ...
                           <th class="text-end">{{__('Amount')}} <br>
                              <small class="text-danger font-weight-bold">@if($TAX_ENABLED)
