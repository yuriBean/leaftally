                   ...
                   success: function(data) {
                       ...
                       if (proposalItems != null) {
                           var itemTaxPrice = parseFloat((totalItemTaxRate / 100)) *
                               parseFloat((proposalItems.price * proposalItems.quantity) -
                                   discount);
                       } else {
                           var itemTaxPrice = parseFloat((totalItemTaxRate / 100)) *
   ...
   <div class="col-12">
                  ...
                  <thead>
                     <tr>
                        ...
                        <th class="text-end">{{ __('Amount') }} <br><small
                           class="text-danger font-weight-bold">@if($TAX_ENABLED)
    ...
    <div class="modal-footer" style="background: #f8f9fa; border-top: 1px solid #e0e0e0; padding: 1.5rem 2rem; display: flex; justify-content: flex-end; gap: 1rem; border-radius: 0 0 8px 8px;">
        <input type="button" value="{{ __('Cancel') }}" onclick="location.href = '{{ route('proposal.index') }}';"
            class="btn btn-light" style="border-radius: 8px; padding: 0.75rem 1.5rem; border: 1.5px solid #e0e0e0; color: #2d3748; font-weight: 500; background: #fff; margin-right: 1rem;">
