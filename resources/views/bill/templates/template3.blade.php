                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" >
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" >{{ __('Number') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::billNumberFormat($settings, $bill->bill_id) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" >{{ __('Issue Date') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::dateFormat($settings, $bill->issue_date) }}</td>
                                    </tr>

                                    <tr>
                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" >{{ __('Due Date') }}:</td>
            ...
            <table class=" bill-summary" style="border-bottom:1px solid {{ $color }};">
                <thead style="background: {{ $color }};color:{{ $font_color }}">
                    <tr>
                        ...
                        <th class="px-4 py-1 border border-[#E5E5E5] bg-[#F6F6F6] font-[600] text-[12px]">{{ __('Price') }} <small>{{ __('after tax & discount') }}</small></th>
                    </tr>
                </thead>
                <tbody>
                    @if (isset($bill->itemData) && count($bill->itemData) > 0)
                        @foreach ($bill->itemData as $key => $item)
                            <tr style="border-bottom:1px solid {{ $color }};">
                                ...
                                <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" >{{ $item->discount != 0 ? Utility::priceFormat($settings, $item->discount) : '-' }}
                                </td>
                                <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" >
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" >{{ __('Credit Note') }}:</td>
