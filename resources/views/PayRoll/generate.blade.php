...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Use event delegation in case element is added later
        document.addEventListener('change', function(event) {
            const target = event.target;
            console.log(target);
            // Check if the changed element is the employee_id_select dropdown
...
<script>
    function removeAllowanceBtn(button) {
        // Removes the nearest parent with class 'allowance-group'
        button.closest('.allowance-group').remove();
    }

    function removeDeductionBtn(button) {
        // Removes the nearest parent with class 'deduction-group'
        button.closest('.deduction-group').remove();
    }

    function removeBonusBtn(button) {
        // Removes the nearest parent with class 'bonus-group'
