<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" style="
...
">
    <style>
        ...
        nav .border-gray-200 {
            border-color: var(--zameen-border) !important;
        }
        ...
        nav .hover\:text-gray-500:hover {
            color: var(--zameen-primary) !important;
        }

        nav .focus\:text-gray-700:focus {
            color: var(--zameen-primary) !important;
        }

        nav a[aria-current="page"] {
            color: var(--zameen-primary) !important;
            border-bottom-color: var(--zameen-primary) !important;
        }
    </style>
