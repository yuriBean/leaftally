    ...
    <div class="zameen-user-card">
        ...
        <div class="zameen-form-container">
            ...
            <div class="zameen-form-group">
                ...
                {{ Form::number('amount', !empty($invoiceDue)?$invoiceDue->getDue():0, ['class' => 'zameen-input', 'required' => 'required', 'step' => '0.01']) }}
            </div>
            <div class="zameen-form-group">
                <label class="zameen-label">{{ __('Description') }}</label>
                {{ Form::textarea('description', '', ['class' => 'zameen-input', 'rows' => 3]) }}
            </div>
        </div>
