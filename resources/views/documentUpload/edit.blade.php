        ...
        <div class="col-md-6 form-group">
            ...
            <div class="choose-file">
                <label for="document" class="form-label">
                    ...
                    {{-- <img id="image" src="{{ $ducumentUpload->document ? \App\Models\Utility::get_file('uploads/documentUpload/'.asset(Storage::url('uploads/documentUpload')).'/'.$ducumentUpload->document) : ''}}" class="mt-3" style="width:25%;"/> --}}
                </label>
            </div>
        </div>
