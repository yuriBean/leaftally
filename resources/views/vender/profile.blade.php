...
<div class="row">
    ...
    <div class="col-xl-9">
                        ...
                        <div class="form-group">
                            <div class="choose-files">
                                <label for="avatar">
                                    ...
                                    <input type="file" name="profile" id="file-1" class="form-control file " onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])" data-multiple-caption="{count} files selected" multiple />
                                    <img id="blah" src="{{ !empty(\Auth::user()->avatar) ? asset(Storage::url(str_replace('app/', '', Auth::user()->avatar))) : asset(Storage::url('uploads/avatar/avatar.png')) }}"
        ...
        <div id="billing_info" class="card">
            ...
            <div class="card-body">
                {{Form::model($userDetail,array('route' => array('vender.update.billing.info'), 'method' => 'post','class'=>'needs-validation','novalidate'))}}
                @csrf
                <div class="row">
        ...
        <div id="shipping_info" class="card">
            ...
            <div class="card-body">
                {{Form::model($userDetail,array('route' => array('vender.update.shipping.info'), 'method' => 'post','class'=>'needs-validation','novalidate'))}}
                @csrf
                <div class="row">
                    <div class="col-lg-4 col-sm-4 form-group">
