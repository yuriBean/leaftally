                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="table-responsive mt-3 mb-3">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th class="px-4 py-1 border border-[#E5E5E5] bg-[#F6F6F6] font-[600] text-[12px]" width="25%">{{__('Category')}}</th>
                                            @foreach($month as $m)
                                                <th class="px-4 py-1 border border-[#E5E5E5] bg-[#F6F6F6] font-[600] text-[12px]" class="px-4 py-3 border border-[#E5E5E5] text-gray-700" width="15%">{{$m}}</th>
                                            @endforeach
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td colspan="13" class="font-bold px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{__('Revenue : ')}}</span></td>
                                        </tr>
                                            ...
                                            @foreach($revenueIncomeArray as $i=>$revenue)
                                                <tr>
                                                    ...
                                                    @foreach($revenue['amount'] as $j=>$amount)
                                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" width="15%">{{\Auth::user()->priceFormat($amount)}}</td>
                                                    @endforeach
                                                </tr>
                                            @endforeach
                                        @endif
                                        ...
                                        <tr>
                                            <td colspan="13" class="font-bold px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{__('Invoice : ')}}</span></td>
                                        </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table class="table table-flush border">
                                                    <tbody>
                                                    <tr>
                                                        <td colspan="13" class="font-bold px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{__('Total Income =  Revenue + Invoice ')}}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="25%" class="px-4 py-3 border border-[#E5E5E5] text-gray-700">{{__('Total Income')}}</td>
                                                        @foreach($totalIncome as $income)
                                                            <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" width="15%">{{\Auth::user()->priceFormat($income)}}</td>
                                                        @endforeach
                                                    </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="table-responsive mt-4">
                                        <table class="table mb-0" >
                                            ...
                                            <tbody>
                                            <tr>
                                                <td colspan="13" class="font-bold px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{__('Payment : ')}}</span></td>
                                            </tr>
                                            ...
                                            @endif
                                            <tr>
                                                <td colspan="13" class="font-bold px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{__('Bill : ')}}</span></td>
                                            </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-flush border" >
                                                        <tbody>
                                                        <tr>
                                                            <td colspan="13" class="font-bold px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{__('Total Expense =  Payment + Bill ')}}</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700">{{__('Total Expenses')}}</td>
                                                            @foreach($totalExpense as $expense)
                                                                <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" width="15%">{{\Auth::user()->priceFormat($expense)}}</td>
                                                            @endforeach
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="col-sm-12">
                                            <table class="table table-flush border" >
                                                <tbody>
                                                    <thead>
                                                    <tr>
                                                        <th class="px-4 py-1 border border-[#E5E5E5] bg-[#F6F6F6] font-[600] text-[12px] font-bold" colspan="13"><span>{{__('Net Profit = Total Income - Total Expense ')}}</span></th>
                                                    </tr>
                                                    </thead>
                                                    <tr>
                                                        <td width="25%" class="px-4 py-3 border border-[#E5E5E5] text-gray-700">{{__('Net Profit')}}</td>
                                                        @foreach($netProfitArray as $i=>$profit)
                                                            <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700" width="15%"> {{\Auth::user()->priceFormat($profit)}}</td>
                                                        @endforeach
                                                    </tr>
                                                </tbody>
                                            </table>
