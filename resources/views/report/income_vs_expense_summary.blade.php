                    ...
                    @if (isset($_GET['category']) && $_GET['period'] == 'quarterly')
                        ...
                        <table id="products-table" class="table border border-[#E5E5E5] rounded-[8px] mt-4">
                            <thead>                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="13" class="px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{ __('Income : ') }}</span></td>
                                    </tr>
                                    <tr>

                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700">{{ __('Revenue') }}</td>
                                    ...
                                    <tr>
                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700">{{ __('Invoice') }}</td>
                                    ...
                                    <tr>
                                        <td colspan="13" class="px-4 py-3 border border-[#E5E5E5] text-gray-700"><span>{{ __('Expense : ') }}</span></td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700">{{ __('Payment') }}</td>
                                    ...
                                    <tr>
                                        <td class="px-4 py-3 border border-[#E5E5E5] text-gray-700">{{ __('Bill') }}</td>
