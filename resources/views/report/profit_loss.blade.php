...
@section('action-btn')
    ...
    <div class="float-end me-2">
        ...
        <button type="submit" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{ __('Export to Excel') }}"
            data-original-title="{{ __('Export to Excel') }}"><i class="fas fa-file-excel"></i></button>
        {{ Form::close() }}
    </div>
