<div class="logo-part-main back-part" id="section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 logo-img">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row" id="image_array">
            ...
            <div class="row com-padding">
                ...
                <div class="col-lg-6 inner-text">
                    <div class="main-inner-text">
                        <span class="heading-btn" id="text-1"></span>
                        <h3 id="text-2"></h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form enctype="multipart/form-data">
                    ...
                    <div class="card mb-2">
                        <div class="card-header"><h6>Logo Images</h6></div>
                        <div class="card-body">
                            <div class="row" id="image_array">
