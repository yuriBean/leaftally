                ...
                <div class="col-lg-3 col-md-4 col-sm-6 py-2">
                    <div class="plan-2">
                        ...
                        <ul class="plan-detail">
                            <li>{{($plan->max_users==-1)?__('Lifetime'):$plan->max_users}} {{__('Users')}}</li>
                            <li>{{($plan->max_customers==-1)?__('Lifetime'):$plan->max_customers}} {{__('Customers')}}</li>
                            <li>{{($plan->max_venders==-1)?__('Lifetime'):$plan->max_venders}} {{__('Vendors')}}</li>
                        </ul>
