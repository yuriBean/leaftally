...
|--------------------------------------------------------------------------
|
| DON’T remove any routes. Feature locking is applied via middleware only.
|
*/
...
Route::group(['middleware' => ['verified']], function () {
    ...
    // ===================== Bank Accounts & Transfers (bookkeeping) =====================
    Route::group(
        [
            'middleware' => [
                'auth',
    ...
    // ===================== Transaction Report (report shell) =====================
    Route::group(
        [
            'middleware' => [
                'auth',
