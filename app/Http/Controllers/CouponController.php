...
class CouponController extends Controller
{
    ...
    public function applyCoupon(Request $request)
    {
        ...
        $decimals = intval(Utility::getValByName('decimal_number'));
                ...
                if ($coupons->limit == $usedCoupun) {
                    ...
                    return response()->json(
                        [
                            ...
                            'final_price' => $price,
                            'price' => number_format($plan_price, $decimals),
    ...
    public function formatPrice($price)
    {
        ...
        $decimalNumber = Utility::getValByName('decimal_number');
        $decimals = intval($decimalNumber);
        return $admin['currency_symbol'] . number_format($price, $decimals);
    }
}
