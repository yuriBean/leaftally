                        ...
                        @csrf
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h5 class="mb-2">{{ __('Testimonials') }}</h5>
                                    </div>
                                    <div class="col switch-width text-end">
                                        <div class="form-group mb-0">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="is_testimonials_section_on"
                                                    id="is_testimonials_section_on"  {{ isset($settings['is_testimonials_section_on']) && $settings['is_testimonials_section_on'] == 'on' ? 'checked="checked"' : '' }}>
                                                <label class="custom-control-label" for="is_testimonials_section_on"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="{{ route('testimonials_create') }}" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="{{ __('Create Testimonial') }}"
